        ...
        for (var i = 0; i < this.props.device.numberOfOutputs + 1; i++) {
            ...
            for (var idx = 0; idx < this.props.device.numberOfInputs + 1; idx++) {
                ...
                if (i === 0 && idx === 0) {
                    ...
                    cell.push(<div key={cellID} id={'out' + i} style={griditemheader}>
                        <Output 
                    ...
                    cell.push(<div key={cellID} id={'in' + i} style={gridcolfixedleft}>
                        <Input rows={this.props.device.numberOfInputPatches} />
                    </div>)
                } else {
                    cell.push(<div key={cellID} id={cellID} style={td}>
                        <Matrix
                            cols={this.props.device.numberOfOutputPatches}
            ...
            cols.push(<div key={i} id={rowID} style={rowstyle}>{cell}</div>)
        }
        return (
