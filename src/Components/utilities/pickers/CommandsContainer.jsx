...
export default function CommandsContainer(props) {
      ...
      <Fragment>
        <div style={redBar}>
          <table style={{ width: "100%" }}>
            <tbody>
              <tr>
                <td style={{ fontSize: "12px" }}>{direction}</td>
                <td style={{ width: "30px" }}>
                  <div
                    style={{
  ...
  const tempCommand = () => {
    return commands.filter(cmd => cmd.id === showPicker.id);
  };
            ...
            <tbody>
              <tr>
                <td style={{ fontSize: "12px" }}>
                  <NameInput
                    value={tempCommand()[0].commandName}
                    setValue={handleNameChange2}
                  />
                </td>
                <td style={{ width: "30px" }}>
                  <div
  ...
  return (
    ...
    >
      <div style={{ margin: "8px" }}>{makeBody()}</div>
    </div>
  );
}
