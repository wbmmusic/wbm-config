...
export const ccDropDown = () => {
  ...
  const ccNameList = [
    ...
    "Undefined",
    "Undefined",
    "LSB Ctrl 0 (Bank Select)",
    "LSB Ctrl 1 (Mod Wheel or Lever)",
    "LSB Ctrl 2 (Breath Ctrl)",
    "LSB Ctrl 3 (Undefined)",
    "LSB Ctrl 4 (Foot Ctrl)",
    "LSB Ctrl 5 (Portamento Time)",
    "LSB Ctrl 6 (Data Entry)",
    "LSB Ctrl 7 (Ch Vol, Main Vol)",
    "LSB Ctrl 8 (Balance)",
    "LSB Ctrl 9 (Undefined)",
    "LSB Ctrl 10 (Pan)",
    "LSB Ctrl 11 (Expression Ctrl)",
    "LSB Ctrl 12 (FX Ctrl 1)",
    "LSB Ctrl 13 (FX Ctrl 2)",
    "LSB Ctrl 14 (Undefined)",
    "LSB Ctrl 15 (Undefined)",
    "LSB Ctrl 16 (Gen Purp Ctrl 1)",
    "LSB Ctrl 17 (Gen Purp Ctrl 2)",
    "LSB Ctrl 18 (Gen Purp Ctrl 3)",
    "LSB Ctrl 19 (Gen Purp Ctrl 4)",
    "LSB Ctrl 20 (Undefined)",
    "LSB Ctrl 21 (Undefined)",
    "LSB Ctrl 22 (Undefined)",
    "LSB Ctrl 23 (Undefined)",
    "LSB Ctrl 24 (Undefined)",
    "LSB Ctrl 25 (Undefined)",
    "LSB Ctrl 26 (Undefined)",
    "LSB Ctrl 27 (Undefined)",
    "LSB Ctrl 28 (Undefined)",
    "LSB Ctrl 29 (Undefined)",
    "LSB Ctrl 30 (Undefined)",
    "LSB Ctrl 31 (Undefined)",
    ...
    "Sound Ctrl 3 (Release Time)",
    "Sound Ctrl 4 (Attack Time)",
    ...
    "FX 4 Depth (Celeste [Detune] Depth)",
    "FX 5 Depth (Phaser Depth)",
