...
export function makeOutputCmd(type, chnl) {
  ...
  if (type === "None") {
    ...
    wasGood = false;
    console.log(
      "ERROR - Command Picker makeCmd didnt recognize this command type " + type
    );
  }
...
export class outputCmdPicker extends Component {
  ...
  handleTypeChange(e) {
    ...
    if (tmpCmd[0]) {
      ...
      if (
      ...
      } else if (e.label === "Program Change" || e.label === "Song Select") {
        let outputDisplay;
        ...
        let outputDisplay;
        if (e.label !== "None") {
          outputDisplay = [decimalToHexString(this.state.command)];
        } else {
          outputDisplay = [];
        }
  ...
  render() {
    ...
    return (
      <div className="pickerTopDiv" style={mainDiv}>
        <table
          id={"pickerTable" + this.props.channel}
          style={{ width: "100%" }}
        >
          <colgroup>
            <col width="1px" />
          ...
          <tbody style={{ width: "100%" }}>
            ...
            <tr>
              <td style={td}>
                <div id="byte0Lbl" style={label}>
                  {b0lbl}
                </div>
              </td>
              <td style={td}>
                <div id="byte0Div">{byte0data}</div>
              </td>
            </tr>
            <tr>
              <td style={td}>
                <div id="byte1Lbl" style={label}>
                  {b1lbl}
                </div>
              </td>
              <td style={td}>
                <div id="byte1Div">{byte1data}</div>
              </td>
            </tr>
            <tr>
              <td style={td}>
                <div id="byte2Lbl" style={label}>
                  {b2lbl}
                </div>
              </td>
              <td style={td}>
                <div id="byte2Div">{byte2data}</div>
              </td>
            </tr>
          </tbody>
        </table>
